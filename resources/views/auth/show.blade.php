    ...
    <div>
        <div class="info-list">
            ...
            <div class="info-item">
                ...
                <div class="info-value"><img width="300" src="{{$user->personal_info->last_degree->url }}" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div>
                    @foreach($user->resume->files as $file)
                        <a href="{{ $file->url }}" download="{{ $file->original_name }}.{{ $file->extension }}">
                            {{ $file->original_name }}.
                            {{ $file->extension }}
                        </a>
                    @endforeach
        ...
        <div class="edit-button-wrapper">
            <a href="?edit=true" class="edit-btn" id="editBtn">ویرایش</a>
        </div>
    </div>
</div>
</body>
