    ...
    <div id="profileSection" class="content-section">
        ...
        <div class="profile-grid">
            <div class="grid-item">
                ...
                <div class="grid-value">{{ $employee->personal_info->fullname }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">شماره تلفن</div>
                <div class="grid-value">{{ $employee->personal_info->phone }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">کد ملی</div>
                <div class="grid-value">{{ $employee->personal_info->national_code }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">شماره شناسنامه</div>
                <div class="grid-value">{{ $employee->personal_info->id_number }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">نام پدر</div>
                <div class="grid-value">{{ $employee->personal_info->father_name }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">تاریخ تولد</div>
                <div class="grid-value">{{ $employee->personal_info->birthdate }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">محل تولد</div>
                <div class="grid-value">{{ $employee->personal_info->birthplace }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">آدرس محل سکونت</div>
                <div class="grid-value">{{ $employee->personal_info->address }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">کد پستی</div>
                <div class="grid-value">{{ $employee->personal_info->postal_code }}</div>
            </div>
            <div class="grid-item">
                <div class="grid-label">نقش شما</div>
                <div class="grid-value">{{ $employee->job->title }}</div>
            </div>
        </div>

        <br>
        <br>
        <form action="{{ route('employee.profile.update') }}" method="post" class="profile-card">
            @csrf
            @method('PATCH')
