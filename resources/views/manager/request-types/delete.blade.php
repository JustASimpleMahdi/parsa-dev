    ...
    <style>
        * {
        ...
        body {
            ...
            background: #1E293B; /* پس‌زمینه اصلی مطابق خواسته */
            color: #E2E8F0;
            line-height: 1.5;
            min-height: 100vh;
            display: flex;
...
<div class="confirm-container">
    <div class="confirm-card">
        ...
        <form action="{{ route('manager.request-types.destroy',['request_type'=>$requestType]) }}" method="post"
              class="button-group">
            @csrf
            @method('DELETE')
            ...
            <a href="{{ route('manager.request-types.index') }}" class="btn btn-cancel">لغو</a>
        </form>
    </div>
</div>
