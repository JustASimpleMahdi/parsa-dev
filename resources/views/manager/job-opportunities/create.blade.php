...
<form action="{{ route('manager.job-opportunities.store') }}" method="post" class="profile-card">
    @csrf
    ...
    <div class="input-group">
        <label>عنوان</label>
        <input name="title" type="text" id="jobTitle" placeholder="عنوان را وارد کنید ... " value="{{ old('title') }}">
    </div>
    ...
    <div class="input-group">
        ...
        <textarea name="description" id="jobDesc"
                  placeholder="توضیحات(حقوق،ساعت کاری و ...) را وارد کنید">{{ old('description') }}</textarea>
    </div>
